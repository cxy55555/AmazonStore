...
Product* ProductBookParser::makeProduct()
{
    ...
    Product* productb = new Book(cate,prodName_,price_,qty_,isbn_,author_);
    return productb;
...
{
    string cate = categoryID();
    Product* productc = new Clothing(cate,prodName_,price_,qty_,size_,brand_);
    return productc;
...
{
    string cate = categoryID();
    Product* productm = new Movie(cate,prodName_,price_,qty_,genre_,rating_);
    return productm;
